...
namespace application{
  ...
  inline void queryOver(){
    ...
    auto edge_fun = std::bind(&edgeApply, _1, _2);
    auto col_fun = std::bind(&Matrix::reduce_column_in_row<long>, graph, _1, _2);
    num_triangles = graph->reduce_row<long>(col_fun, edge_fun);
  }
}
...
int main (int argc, char* argv[]) { 
  ...
  common::startClock();
  Matrix* allocated_graph = new Matrix(-1, inputGraph.out_neighborhoods,
