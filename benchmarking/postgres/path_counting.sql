\timing on
CREATE TEMPORARY VIEW frontier1 AS SELECT e1.b AS v FROM edge e1 WHERE e1.a = 222074;
CREATE TEMPORARY VIEW visited1 AS SELECT 222074 UNION SELECT * FROM frontier1;
